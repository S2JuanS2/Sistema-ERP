Feature: Get cost of all projects
  ...
  Scenario: Successfully get cost of all projects
    ...
    And I have a project with name "Aplicación de Comercio Electrónico (E-commerce)" that lasted 1 month and cost "3000"
    When I get the total cost of the project
    Then the system should return the total cost of the project "6000"