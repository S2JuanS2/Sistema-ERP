Feature: Modify cost of a role
  ...
  Scenario: Successfully modify cost of a role
    ...
    When I PUT to the route "/api/v1/finanzas/costos/1/actualizar-costo" with rol id 1
  ...
  Scenario: Fail to modify cost of a role due to negative amount
    ...
    When I PUT to the route "/api/v1/finanzas/costos/2/actualizar-costo" with rol id 2
    ...
    When I PUT to the route "/api/v1/finanzas/costos/999/actualizar-costo" with rol id 999
