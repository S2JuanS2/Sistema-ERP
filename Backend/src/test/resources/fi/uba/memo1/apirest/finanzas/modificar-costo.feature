Feature: Modify cost of a role
  ...
  Scenario: Successfully modify cost of a role
    ...
    When I PUT to the route "/api/v1/finanzas/costos/actualizar-costo/1" with rol id 1
  ...
  Scenario: Fail to modify cost of a role due to negative amount
    ...
    When I PUT to the route "/api/v1/finanzas/costos/actualizar-costo/1" with rol id 2
    ...
    When I PUT to the route "/api/v1/finanzas/costos/actualizar-costo/999" with rol id 999
